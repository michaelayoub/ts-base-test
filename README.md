...
- `src/core/internal.ts`: core logic, no Node/browser APIs
- `src/core/index.ts`: Node adapter (e.g., `crypto.randomBytes`)
- `src/core/browser.ts`: browser adapter (e.g., `crypto.getRandomValues`)
